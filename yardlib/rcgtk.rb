...
# Date:        2012/05/21
# Description: YARD extensions for documenting RCGTK.  All of the current code
#              was taken from Jeremy Voorhis's project ruby-llvm, and credit
#              should go to him.

class RCGTKTagFactory < YARD::Tags::DefaultFactory
...
YARD::Tags::Library.default_factory = RCGTKTagFactory
